...
public class ImageConverter {
    public static BufferedImage[] animationFrames(Animation animation) {
        BufferedImage[] frames = new BufferedImage[animation.getNumFrames()]; for (int i = 0; i < frames.length; i++) {
    ...
    public static Animation framesAsAnimation(BufferedImage[] frames, int fps) {
        Animation animation = new Animation(fps); for (BufferedImage frame : frames) {
