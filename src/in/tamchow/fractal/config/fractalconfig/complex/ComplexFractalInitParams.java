...
public class ComplexFractalInitParams implements Serializable, DataFromString {
    ...
    private void initParams(int width, int height, double zoom, double zoom_factor, double base_precision, int fractal_mode, String function, String[][] consts, String variableCode, double tolerance, Complex degree, ColorConfig colors, int switch_rate, Complex trap_point) {
        this.width = width;
        this.height = height;
        this.zoom = zoom;
        ...
        setColor(colors); setTrap_point(trap_point);
    }
    ...
    public ComplexFractalInitParams(int width, int height, double zoom, double zoom_factor, double base_precision, int fractal_mode, String function, String[][] consts, String variableCode, double tolerance, Complex degree, ColorConfig color, int switch_rate, Complex trap_point) {
        initParams(width, height, zoom, zoom_factor, base_precision, fractal_mode, function, consts, variableCode, tolerance, degree, color, switch_rate, trap_point);
    }
    public ComplexFractalInitParams() {
        ...
        initParams(1921, 1081, 10, 0, 540, ComplexFractalGenerator.MODE_JULIA, func, consts, "z", 1e-5, new Complex("-1"), cfg, 0, Complex.ZERO);
    }
    ...
    private void initParams(int width, int height, double zoom, double zoom_factor, double base_precision, int fractal_mode, String function, String[][] consts, String variableCode, double tolerance, Complex degree, ColorConfig colors, int switch_rate) {
        ...
        this.degree = new Complex(degree); setColor(colors); setTrap_point(Complex.ZERO);
    }
}