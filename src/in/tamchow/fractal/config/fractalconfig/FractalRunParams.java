...
public class FractalRunParams {
    ...
    public FractalRunParams(FractalRunParams runParams) {
        if (runParams.fully_configured) {
            initParams(runParams.start_x, runParams.end_x, runParams.start_y, runParams.end_y, runParams.iterations, runParams.escape_radius);
            fully_configured = true;
        } else {
            initParams(runParams.iterations, runParams.escape_radius);
