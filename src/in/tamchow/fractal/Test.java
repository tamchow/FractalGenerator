...
public class Test {
    public static void main(String[] args) {
        ...
        int resx = 640, resy = 480, fracmode = ComplexFractalGenerator.MODE_MANDELBROT, iter = 32, switch_rate = 0;
        double escrad = 10, tolerance = 1e-15, zoom = 10, zoompow = 0, baseprec = 200; String linetrap = null;
        ColorConfig cfg = new ColorConfig(Colors.CALCULATIONS.STRIPE_AVERAGE_LINEAR, 4, 10, true, true);
