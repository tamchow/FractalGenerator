...
public class Test {
    public static void main(@NotNull String[] args) {
        @NotNull String func = "( z ^ 3 ) + ( ( d ) * ( z ) ) + e", variableCode = "z", poly = "1:z:3,+,d:z:1,+,e",
                poly2 = "1;tan;1:z:1", poly3 = "1:z:4,-,1", poly4 = "1:z:1;sin;1:z:2;-1", poly5 = "1:z:8,+,15:z:4,-,16", func2 = "z ^ 2 + f";
        ...
        //cfg.setPalette(new int[]{Colors.BASE_COLORS.GREEN, Colors.BASE_COLORS.BLUE, Colors.BASE_COLORS.RED, Colors.BASE_COLORS.YELLOW, Colors.BASE_COLORS.MAGENTA, Colors.BASE_COLORS.CYAN}, false);
