...
public class Test {
    public static void main(String[] args) {
        String func = "z ^ 2 + e", variableCode = "z", poly = "{1:z:2};+;{e:z:0}";
        String[][] consts = {{"c", "-0.1,+0.651i"}, {"d", "-0.7198,+0.911i"}, {"e", "-0.8,+0.156i"}, {"f", "-0.5,+0.25i"}};
        int resx = 1366, resy = 768, fracmode = ComplexFractalGenerator.MODE_JULIA, iter = 32;
        double escrad = 100, tolerance = 1e-10, zoom = 10, zoompow = 0, baseprec = 350;
        ColorConfig cfg = new ColorConfig(Colors.CALCULATIONS.COLOR_HISTOGRAM_LINEAR, 32767, 65536, true, true);
