...
public class Test {
    public static void main(String[] args) {
        ...
        double escrad = 100, tolerance = 1e-10, zoom = 10, zoompow = 0, baseprec = 200;
        ColorConfig cfg = new ColorConfig(Colors.CALCULATIONS.STRIPE_AVERAGE_SPLINE, 8, 65536, true, true);
