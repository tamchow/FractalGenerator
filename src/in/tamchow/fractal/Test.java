...
public class Test {
    public static void main(String[] args) {
        String func = "( z ^ 3 ) + ( ( d ) * ( z ) ) + e", variableCode = "z", poly = "{1:z:3};+;{d:z:1};+;{e:z:0}", poly2 = "{f:z:0};sin;{1:z:1}", poly3 = "{1:z:5};+;{1:z:0}", func2 = "z ^ 2 + e";
        String[][] consts = {{"c", "-0.1,+0.651i"}, {"d", "-0.7198,+0.9111i"}, {"e", "-0.8,+0.156i"}, {"f", "0.5,+0.25i"}, {"g", "1,+0.3i"}};
        int resx = 640, resy = 480, iter = 32, switch_rate = 0;
        ComplexFractalGenerator.Mode fracmode = ComplexFractalGenerator.Mode.NEWTON;
        double escrad = 10, tolerance = 1e-10, zoom = 10, zoompow = 0, baseprec = 200; String linetrap = null;
        //Note to self: Do NOT use TIA and Exp. Smoothing together.
        Color_Utils_Config cfg = new Color_Utils_Config(Colors.CALCULATIONS.COLOR_NEWTON_CLASSIC, 4, 5, 0, true, true);
        ...
        Complex trap = new Complex(0.15); int x_t = 2, y_t = 2; double skew = 0 * Math.PI; func = poly3;
