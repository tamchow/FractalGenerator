...
public class Test {
    public static void main(String[] args) {
        ...
        double escrad = 10, tolerance = 1e-15, zoom = 10, zoompow = 0, baseprec = 200; String linetrap = "1,1,0";
        ColorConfig cfg = new ColorConfig(Colors.CALCULATIONS.LINE_TRAP_MIN, 4, 50, true, true);
        ...
        boolean def = (args.length == 0); ComplexFractalConfig fccfg = new ComplexFractalConfig(0, 0, 0); if (!def) {
            ...
            jgen = new ComplexFractalGenerator(resx, resy, zoom, zoompow, baseprec, fracmode, func, consts, variableCode, tolerance, cfg, new DesktopProgressPublisher(), switch_rate, linetrap);
