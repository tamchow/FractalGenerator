...
public class Test {
    public static void main(@NotNull String[] args) {
        @NotNull String func = "(z^3)+((d)*(z))+e", variableCode = "z", poly = "1:z:3,+,d:z:1,+,e",
                poly2 = "1;tan;1:z:1;1", poly3 = "1:z:4,-,1", poly4 = "1:z:1;sin;1:z:2;1;-1", poly5 = "1:z:8,+,15:z:4,-,16", func2 = "z ^ 2 + f", magnet1 = "((z^2+c-1)/(2*z+c-2))^2", magnet2 = "((z^3+3*(c-1)*z+(c-1)*(c-2))/(3*(z^2)+3*(c-2)*z+(c-1)*(c-2)+1))^2";
        ...
        double escrad = 1E10, tolerance = 1e-15, zoom = 10, zoompow = 0, baseprec = 250;
        @Nullable String linetrap = null;
        @NotNull Colorizer cfg = new Colorizer(Colors.MODE.EPSILON_CROSS_SPLINE, 4, 250000, 0, true, true);
        func = magnet1;
