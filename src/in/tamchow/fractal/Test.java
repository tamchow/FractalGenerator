...
public class Test {
    public static void main(String[] args) {
        ...
        int resx = 1921, resy = 1081, fracmode = ComplexFractalGenerator.MODE_JULIA, iter = 128;
        double escrad = 100, tolerance = 1e-10, zoom = 10, zoompow = 0, baseprec = 500;
        ColorConfig cfg = new ColorConfig(Colors.CALCULATIONS.CURVATURE_AVERAGE, 19, 16, true, true);
