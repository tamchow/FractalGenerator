...
public class Test {
    public static void main(String[] args) {
        ...
        int resx = 1920, resy = 1080, fracmode = ComplexFractalGenerator.MODE_JULIA, iter = 64, switch_rate = 0;
        double escrad = 1E10, tolerance = 1e-15, zoom = 10, zoompow = 0, baseprec = 500; String linetrap = null;
        ColorConfig cfg = new ColorConfig(Colors.CALCULATIONS.EPSILON_CROSS_LINEAR, 4, 65536, true, true);
        ...
        Complex trap = new Complex(0.15); func = func2;
