...
public class Test {
    public static void main(String[] args) {
        ...
        double escrad = 100, tolerance = 1e-15, zoom = 10, zoompow = 0, baseprec = 200; String linetrap = null;
        ColorConfig cfg = new ColorConfig(Colors.CALCULATIONS.CURVATURE_AVERAGE_LINEAR, 4, 25, 0, true, false);
        ...
        Complex trap = new Complex(0.15); int x_t = 3, y_t = 3; double skew = 0 * Math.PI; func = func2;
