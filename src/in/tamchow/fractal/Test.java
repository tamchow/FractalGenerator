...
public class Test {
    public static void main(String[] args) {
        ...
        int resx = 1366, resy = 768, iter = 32, switch_rate = 0;
        ComplexFractalGenerator.Mode fracmode = ComplexFractalGenerator.Mode.RUDY;
        double escrad = 10, tolerance = 1e-10, zoom = 10, zoompow = 0, baseprec = -1; String linetrap = null;
        //Note to self: Do NOT use TIA and Exp. Smoothing together.
        Color_Utils_Config cfg = new Color_Utils_Config(Colors.CALCULATIONS.STRIPE_AVERAGE_SPLINE, 4, 250000, 0, true, true);
        ...
        Complex trap = new Complex(0.1); int x_t = 4, y_t = 2; double skew = 0.5 * Math.PI; //func = poly3;
