...
public class Test {
    public static void main(String[] args) {
        ...
        int resx = 1920, resy = 1080, fracmode = ComplexFractalGenerator.MODE_JULIA, iter = 16, switch_rate = 0;
        double escrad = 10, tolerance = 1e-15, zoom = 10, zoompow = 0, baseprec = 500; String linetrap = null;
        ColorConfig cfg = new ColorConfig(Colors.CALCULATIONS.COLOR_HISTOGRAM_LINEAR, 4, 65536, true, true);
