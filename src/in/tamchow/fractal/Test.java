...
public class Test {
    public static void main(String[] args) {
        String func = "( z ^ 3 ) + ( ( d ) * ( z ) ) + e", variableCode = "z", poly = "{1:z:3};+;{d:z:1};+;{e:z:0}", poly2 = "{f:z:0};sin;{1:z:1}", poly3 = "{1:z:5};+;{e:z:0}", func2 = "z ^ 2 + e";
        ...
        Color_Utils_Config cfg = new Color_Utils_Config(Colors.CALCULATIONS.STRIPE_AVERAGE_SPLINE, 4, 25000, 0, true, false);
        ...
        File pic = new File("D:/Fractal.png");
        try {
