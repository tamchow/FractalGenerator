...
public class Test {
    public static void main(String[] args) {
        String func = "( z ^ 3 ) + ( ( d ) * ( z ) ) + e", variableCode = "z", poly = "{1:z:3};+;{d:z:1};+;{e:z:0}", poly2 = "{f:z:0};sin;{1:z:1}", poly3 = "{1:z:4};+;{1:z:0}", func2 = "z ^ 4 + 1";
        String[][] consts = {{"c", "-0.1,+0.651i"}, {"d", "-0.7198,+0.9111i"}, {"e", "-0.8,+0.156i"}, {"f", "0.5,+0.25i"}, {"g", "1,+0.3i"}};
        int resx = 640, resy = 480, iter = 64, switch_rate = 0;
        ComplexFractalGenerator.Mode fracmode = ComplexFractalGenerator.Mode.SECANT;
        double escrad = 10, tolerance = 1e-10, zoom = 10, zoompow = 0, baseprec = -1;
        String linetrap = null;
        //Note to self: Do NOT use TIA and Exp. Smoothing together.
        Color_Utils_Config cfg = new Color_Utils_Config(Colors.CALCULATIONS.TRIANGLE_AREA_INEQUALITY_SPLINE, 4, 25, 0, true, false);
