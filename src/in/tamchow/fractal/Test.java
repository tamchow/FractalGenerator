...
public class Test {
    public static void main(@NotNull String[] args) {
        @NotNull String func = "(z^3)+((d)*(z))+e", variableCode = "z", poly = "1:z:3,+,d:z:1,+,e",
                ...
                func2 = "((z^2)/(1+(h*z)))+j", func3 = "z^2+f", magnet1 = "((z^2+c-1)/(2*z+c-2))^2",
        ...
        double escrad = 10, tolerance = 1e-15, zoom = 1, baseprec = -1;
        @Nullable String linetrap = null;
        @NotNull Colorizer cfg = new Colorizer(Colors.MODE.STRIPE_AVERAGE, 4, 250000, 0, true, false, false, false, false, false, -1);
        //func = func2;
        ...
        //cfg.createSmoothPalette(new int[]{Colors.BASE_COLORS.BLACK, Colors.BASE_COLORS.RED, Colors.BASE_COLORS.YELLOW, Colors.BASE_COLORS.GREEN, Colors.BASE_COLORS.CYAN, Colors.BASE_COLORS.BLUE, Colors.BASE_COLORS.MAGENTA, Colors.BASE_COLORS.WHITE}, new double[]{0.125, 0.25, 0.375, 0.5, 0.625, 0.75, 0.875, 1.0});
        ...
        //System.out.println(Arrays.deepToString(jgen.getNormalized_escapes()));
        ...
        try {
            ImageIO.write(ImageConverter.toImage(jgen.getArgand().getPostProcessed(
                    ...
                    jgen.getColor().isLinearInterpolation(), jgen.getColor().isGammaCorrection())), "png", pic);
