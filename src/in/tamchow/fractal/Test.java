...
public class Test {
    public static void main(String[] args) {
        ...
        int resx = 1920, resy = 1080, fracmode = ComplexFractalGenerator.MODE_RUDY, iter = 32, switch_rate = 0;
        double escrad = 10, tolerance = 1e-15, zoom = 10, zoompow = 0, baseprec = 500; String linetrap = null;
        ColorConfig cfg = new ColorConfig(Colors.CALCULATIONS.CURVATURE_AVERAGE_LINEAR, 4, 65536, true, true);
        ...
        Complex trap = new Complex(0.01);//func = func2;
        ...
        ComplexFractalParams jgenParams = null; if (def) {
            ...
            } jgenParams.x_threads = 4; jgenParams.y_threads = 3;
        ...
        if (def) {
            if (jgenParams.useThreadedGenerator()) {
                ThreadedComplexFractalGenerator threaded = new ThreadedComplexFractalGenerator(jgen, jgenParams);
                threaded.generate();
