...
public class Test {
    public static void main(String[] args) {
        ...
        int resx = 640, resy = 480, fracmode = ComplexFractalGenerator.MODE_MANDELBROT, iter = 16, switch_rate = 0;
        double escrad = 1E10, tolerance = 1e-15, zoom = 10, zoompow = 0, baseprec = 200;
        ...
        Complex trap = new Complex(Complex.ZERO);
        func = poly;
        boolean def = (args.length == 0); ComplexFractalConfig fccfg = new ComplexFractalConfig(0, 0, 0); if (!def) {
            ...
            jgen = new ComplexFractalGenerator(resx, resy, zoom, zoompow, baseprec, fracmode, func, consts, variableCode, tolerance, cfg, new DesktopProgressPublisher(), switch_rate, trap);
