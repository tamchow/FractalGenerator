...
public class Test {
    public static void main(String[] args) {
        ...
        int resx = 1920, resy = 1080, fracmode = ComplexFractalGenerator.MODE_JULIA, iter = 32, switch_rate = 0;
        double escrad = 2, tolerance = 1e-15, zoom = 10, zoompow = 0, baseprec = 500; String linetrap = null;
        ColorConfig cfg = new ColorConfig(Colors.CALCULATIONS.DOMAIN_COLORING, 4, 36, true, true);
        cfg.setBasecolor(0xffffff / 2);
        ...
        Complex trap = new Complex(0.15); func = func2; int x_t = 4, y_t = 3;
