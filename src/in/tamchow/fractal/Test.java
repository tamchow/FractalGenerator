...
public class Test {
    public static void main(String[] args) {
        ...
        double escrad = 10, tolerance = 1e-10, zoom = 10, zoompow = 0, baseprec = 200;
        ColorConfig cfg = new ColorConfig(Colors.CALCULATIONS.DISTANCE_ESTIMATION_COLOR, 8, 255, true, false);
