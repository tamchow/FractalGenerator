...
public class UnmatchedLiteralException extends RuntimeException {
    String message;
    Throwable cause;
    public UnmatchedLiteralException(String message) {this.message = message; cause = null;}
    public UnmatchedLiteralException(String message, Throwable cause) {this.message = message; this.cause = cause;}
    @Override
