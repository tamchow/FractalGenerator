...
public class UnrecognizedLiteralException extends RuntimeException {
    String message;
    Throwable cause;
    public UnrecognizedLiteralException(String message) {this.message = message; cause = null;}
    public UnrecognizedLiteralException(String message, Throwable cause) {this.message = message; this.cause = cause;}
    @Override
